...
public class UserDAO {
    ...
    public static List<UserP3> getAllUsers() throws SQLException {
        Connection con = getConnection();
        Statement stmt= null;
        try {
        ...
        List<UserP3> lista = new ArrayList<UserP3>();
        while (rs.next()){
            //UserP3 user = new UserP3(rs.getInt("id"),rs.getString("name"),rs.getString("address"));
            //lista.add(user);
        }
